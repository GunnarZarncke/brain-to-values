...
\title{From Free--Energy Loops to Human Values: Hubs as Bottlenecks}
...
Table~\ref{tab:hv} lists the hubs, the principal loops that feed them, and representative intrinsic values from \citet{zarncke2025stratification}.
...
\begin{figure}[h]
  \centering
  \includegraphics[width=\linewidth]{figures/brain-values-schematic.pdf}
  \caption{Hub-centric brain--value mapping. Neuromodulatory and salience hubs (inner ring) project intrinsic value tags (outer ring), compiled from \citet{zarncke2025stratification}.}
  \label{fig:lhvchart}
\end{figure}
...
\bibitem[Zarncke(2025)]{zarncke2025stratification}
Gunnar~Zarncke.
\newblock Stratification of free--energy--minimising loops in the vertebrate brain.
\newblock Companion manuscript, brain-to-values research program, AE Studio, 2025.
