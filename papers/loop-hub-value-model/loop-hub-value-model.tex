...
\begin{figure}[h]
  ...
  \caption{Hub-centric brain--value mapping. Neuromodulatory and salience hubs (inner ring) project intrinsic value tags (outer ring), compiled from Zarncke (2025).}
  \label{fig:lhvchart}
\end{figure}
